  ...
  if (type == "survival") {
    ...
    if (nrow(predictors) > 1) {
      for (r in 1:nrow(predictors)) {
        ...
        preds <- as.data.frame(predict_survival_gibbs_cpp(eval_time, predictors[r, ], 
                                                          beta, sigma, eta, 
      ...
      preds <- as.data.frame(predict_survival_gibbs_cpp(eval_time, predictors[1, ], 
                                                        beta, sigma, eta, 
                                                        interval == 'credible', level))
    ...
    if (nrow(predictors) > 1) {
      for (r in 1:nrow(predictors)) {
        ...
        preds <- as.data.frame(predict_hazard_gibbs_cpp(eval_time, predictors[r, ], 
                                                        beta, sigma, eta, 
                                                        interval == 'credible', level))
      ...
      preds <- as.data.frame(predict_hazard_gibbs_cpp(eval_time, predictors[1, ], 
                                                      beta, sigma, eta, 
                                                      interval == 'credible', level))
