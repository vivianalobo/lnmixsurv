...
This vignette shows a brief comparison of the survival_ln_mixture with
other survival models, available through `censored`.
...
# Gerando dados
data <- simulate_data(
  n = 6000, k = 3, mixture_components = 2,
...
Finally, thanks to the great parsnip API, we can fit and predict all
models at once.
...
The following plot compares each model with the Kaplan-Meier estimates
