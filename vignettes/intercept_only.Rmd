...
km <- survival::survfit(Surv(y, delta) ~ NULL, 
                        sim_data$data) |> 
...
ggplot() +
  ...
  labs(title = "Fitted survival estimates",
       x = "t",
       y = "S(t)",
       linetype = 'Type') +
  theme_bw()
