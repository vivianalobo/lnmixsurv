...
public: // ===== main methods =====
    ...
    void update(float progress)
    {
        ...
        else
        {
            ...
            std::string rem = _time_to_string(rem_time);
            std::string pas = _time_to_string(pas_time);
            ...
            strs << "|" << progress_bar_string << "| " << rem << " (" << pas << ")"
                 << "         ";
...
protected: // ==== other instance methods =====
    ...
    std::string _time_to_string(double seconds)
    {
        ...
        std::stringstream sec_strs;
        std::stringstream min_strs;
        std::stringstream hour_strs;
        if(sec <= 9){
            sec_strs << "0" << sec;
        }else{
            sec_strs << sec;
        ...
        time_strs << hour_strs.str() << "h" << min_strs.str() << "min" << sec_strs.str() << "s";
