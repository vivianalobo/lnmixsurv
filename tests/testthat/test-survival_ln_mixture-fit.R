...
test_that("survival_ln_mixture works with intercept only fit", {
  ...
  expect_equal(tidy(mod)$estimate, c(4.399466, 3.518093))
})
...
test_that("fit works as expected with simulated data", {
  ...
  expected_result <- structure(
    list(term = c(
      ...
      4.0455659,
      0.8072690, 3.4262658, 0.4874025, 26.6440591,
      3.1884579, 0.5072736
    ), std.error = c(
      0.006567584,
      0.009969275, 0.020706785, 0.023423408, 1.413369215,
      0.121097913, 0.012291352
    )),
