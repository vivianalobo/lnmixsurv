# plot_fit_on_data works for Bayesian model with covariates
    ...
    Output
      # A tibble: 10,000 x 12
       ...
       8  4.27   6027       1        0    1.000  0.000166         1    1.000 x=0   
       9  4.57   6026       0        1    1.000  0.000166         1    1.000 x=0   
      10  4.86   6025       0        1    1.000  0.000166         1    1.000 x=0   
      # i 9,990 more rows
...
# plot_fit_on_data works for Bayesian model with intercept only
    ...
    Output
      # A tibble: 9,999 x 11
       ...
       8  4.27   9993       1        0    1.000  0.000100         1    1.000
       9  4.57   9992       0        1    1.000  0.000100         1    1.000
      10  4.86   9991       0        1    1.000  0.000100         1    1.000
      # i 9,989 more rows
      # i 3 more variables: .pred_survival <dbl>, .pred_lower <dbl>,
      #   .pred_upper <dbl>
